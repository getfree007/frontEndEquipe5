...
import { ChartistType } from './chartist.model';
...
const simpleLineChart: ChartistType = {
    data: {
...
const areaLineChart: ChartistType = {
    data: {
...
const overlappingBarChart: ChartistType = {
    data: {
...
const stackBarChart: ChartistType = {
    data: {
        labels: ['Mercado Livre', 'Amazon', 'Magazine Luiza', 'Via Varejo'],
        series: [
            [80, 120, 140, 130],
            [2000, 4000, 5000, 3000],
        ]
...
const horizontalBarChart: ChartistType = {
    data: {
...
const donutAnimateChart: ChartistType = {
    data: {
...
const simplePieChart: ChartistType = {
    data: {
        series: [5, 3, 4]
    },
    options: {
